...
from brickv.plugin_system.plugins.red.ui_vision_page_general import Ui_VisionPageGeneral
from brickv.plugin_system.plugins.red.vision_page import VisionPage
from brickv.utils import get_main_window
import re

class VisionPageGeneral(VisionPage, Ui_VisionPageGeneral):
    def __init__(self, title_prefix=''):
        VisionPage.__init__(self)
    ...
    def isComplete(self):
        ...
        #        VisionPage.isComplete(self)

    # overrides VisionPage.update_ui_state
