...
from brickv.plugin_system.plugins.red.vision_page_general import VisionPageGeneral
from brickv.plugin_system.plugins.red.vision_wizard import VisionWizard

class ConstantsVision(object):
    PAGE_GENERAL    = 4001
    PAGE_FILES      = 1002
    PAGE_SUMMARY    = 1018
    PAGE_UPLOAD     = 1019
...
class VisionWizardNew(VisionWizard):
    def __init__(self, parent, context):
        VisionWizard.__init__(self, parent, context)

        self.setWindowTitle('New Vision Program')

        # FIXME TEMP ID
        self.setPage(ConstantsVision.PAGE_GENERAL, VisionPageGeneral(title_prefix='Step 1 of 1: '))
    ...
    def nextId(self):
        ...
        if currentId == ConstantsVision.PAGE_GENERAL:
            return ConstantsVision.PAGE_SUMMARY
        ...
        #     return -1
            ...
            return ConstantsVision.PAGE_GENERAL
